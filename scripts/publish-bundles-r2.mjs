 ...
 * Layout, and why:
 *
 *   miniapps/<slug>/<version>/**            the bundle, immutable for a year
 *   meta/miniapps/<slug>/latest.json        the pointer, 60s
 *   catalog/miniapps.json                   meta + logo for the launcher, 60s
 *
