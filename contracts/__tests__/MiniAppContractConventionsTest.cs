...
{
    /// <summary>
    /// Conventions every app contract in this repo has to follow.
    ///
    ...
    public class MiniAppContractConventionsTest
    {
        ...
        [Fact]
        public void TheBuildDirectoryHoldsTheAppContracts()
        {
        ...
        [Fact]
        public void EveryAppContractExposesAnUpdateMethod()
        {
